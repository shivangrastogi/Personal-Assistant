...
from DATA.TTS_MINIMAL.tts.layers.feed_forward.decoder import Decoder
from DATA.TTS_MINIMAL.tts.layers.feed_forward.encoder import Encoder
from DATA.TTS_MINIMAL.tts.layers.generic.aligner import AlignmentNetwork
from DATA.TTS_MINIMAL.tts.layers.generic.pos_encoding import PositionalEncoding
from DATA.TTS_MINIMAL.tts.layers.glow_tts.duration_predictor import DurationPredictor
from DATA.TTS_MINIMAL.tts.models.base_tts import BaseTTS
from DATA.TTS_MINIMAL.tts.utils.helpers import average_over_durations, generate_path, maximum_path, sequence_mask
from DATA.TTS_MINIMAL.tts.utils.speakers import SpeakerManager
from DATA.TTS_MINIMAL.tts.utils.text.tokenizer import TTSTokenizer
from DATA.TTS_MINIMAL.tts.utils.visual import plot_alignment, plot_avg_energy, plot_avg_pitch, plot_spectrogram
from DATA.TTS_MINIMAL.utils.io import load_fsspec
...
class ForwardTTS(BaseTTS):
    ...
    def get_criterion(self):
        from DATA.TTS_MINIMAL.tts.layers.losses import ForwardTTSLoss  # pylint: disable=import-outside-toplevel
